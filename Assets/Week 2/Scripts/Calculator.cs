...
public class Calculator : MonoBehaviour
{
    ...
    public TextMeshProUGUI CalculatorScreen;
    ...
    public void SetEquationAsAdd()
    {
        ...
        prevInput = float.Parse(CalculatorScreen.text);
        clearPrevInput = true;
    ...
    public void Add()
    {
        ...
        CalculatorScreen.text = $"{prevInput + float.Parse(CalculatorScreen.text)}";
    }
